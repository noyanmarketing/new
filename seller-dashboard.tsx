...
import { Home, Package, Settings, ShoppingCart, TrendingUp, Eye, Edit, Send, Trash2, Plus, X, Upload } from 'lucide-react';
...
const Sidebar = ({ activePage, setActivePage }: any) => (
  <div className="w-64 bg-green-800 text-white p-4 flex flex-col">
    ...
    <div className="pt-4 border-t border-green-700">
      <button className="w-full flex items-center gap-3 px-4 py-3 text-green-100 hover:bg-green-700/50 rounded-lg">
